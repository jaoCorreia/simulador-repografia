...
export const audioCatalog = [
  ...
  { id: 'coffee-pour', seconds: 1.4, prompt: 'A small ceramic mug tilted and spilling coffee onto a wooden desktop: a gentle continuous thin liquid trickle, several clear soft splatters forming a little puddle, a few ending drops. Cozy close-up liquid Foley, no cup impact, no voices, no music, no background. Immediate start.' },
